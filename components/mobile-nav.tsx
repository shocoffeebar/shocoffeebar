...
export function MobileNav({ items }: MainNavProps) {
  ...
  return (
    //Hambuger menu
    <div className="flex flex-row justify-between sm:hidden mt-4">
      ...
      >
        <span
          className={`bg-white block transition-all duration-300 ease-out 
                    h-0.5 w-[50px] rounded-sm ${
                      isOpen ? 'rotate-45 translate-y-1' : '-translate-y-0.5'
                    }`}
        ></span>
        <span
          className={`bg-white block transition-all 
                    h-0.5 w-[50px] rounded-sm my-0.5 ${
      ...
      {items?.length
        ? isOpen && (
            <div className="bg-[#101010] h-screen w-screen absolute top-[4.5rem] group-focus:top-0 right-0 duration-150 flex flex-col space-y-8 pt-8 pb-12 items-center text-center">
              ...
              <div className="flex flex-row text-white gap-x-24">
                <Link
