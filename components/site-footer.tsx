...
export function SiteFooter() {
  return (
    <footer className="bg-[#252525] flex flex-col px-[30px] md:px-24 py-16">
      <div className="flex flex-col text-center md:px-[100px] text-white">
        <div className="flex flex-col md:flex-row items-center justify-around mb-12 gap-y-[20px]">
          <div className="flex-col flex md:gap-y-4">
            <h2 className="text-[20px] md:text-[36px] font-[500]">Email</h2>
            <Link
              href="mailto:info@shocoffeebar.com"
              className="text-[16px] md:text-[20px] font-[300] underline-hover hover:text-[#888888] cursor-pointer"
            >
              info@shocoffeebar.com
            </Link>
          </div>
          <div className="flex-col flex md:gap-y-4">
            <h2 className="text-[20px] md:text-[36px] font-[500]">Address</h2>
            <Link
          ...
          <div className="flex-col flex md:gap-y-4 md:mt-6">
            <h2 className="text-[20px] md:text-[36px] font-[500]">Socials</h2>
            <div className="flex flex-row text-white gap-x-[20px] mt-2">
              <Link
              ...
              >
                <svg
                  ...
                  fill="#ffffff"
                  viewBox="0 0 448 512"
                  className="rounded-full md:p-2 bg-[#252525] hover:bg-[#888888] transition-all duration-200 ease-in cursor-pointer icon h-[24px] w-[24px] md:h-[50px] md:w-[50px]"
                >
