...
export default function About() {
  return (
    <main className="flex min-h-screen flex-col bg-black text-white">
      ...
      <div className="grid grid-cols-3 bg-white text-black items-center px-64 py-24">
        <h1 className="col-span-3 text-center text-[36px] font-[500]">Team</h1>
        <div className="flex flex-col items-center justify-center  gap-y-4">
          ...
          <h2 className="text-[28px] font-[300]">Gregory</h2>
        ...
        <div className="flex flex-col items-center justify-center  gap-y-4">
          ...
          <h2 className="text-[28px] font-[300]">Serhii</h2>
